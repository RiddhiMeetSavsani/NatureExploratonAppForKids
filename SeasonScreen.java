...
public class SeasonScreen extends Application {
    ...
    private String[] animalNames = {"Winter", "Summer", "Monsoon"};
    private String[] animalInfoTexts = {
            "Hi kids!I’m Winter.\nI bring cold weather,\nsnow,and cozy times.\nWhen I’m here,you\ncan build snowmen,go\nsledding,and have\nsnowball fights.\nAnimals hibernate,and\nsome trees lose their\nleaves.",
            "Hey there!I’m Summer.\nI’m the warmest\nseason of the year,\nwith lots of sunshine\nand long days.\nSchool is out,so\nit’s time for vacations,\nswimming,and playing at\nthe beach.",
            "Hey kids,I’m the\nMonsoon!\nI bring rain and\nexcitement to the land.\nWhen I arrive,I fill the\nsky with big,fluffy clouds and\nsprinkle raindrops all around.\nI bring help to trees,and\nrivers to grow strong."
    };
    ...
    private String[] animalImagePaths = {"/Project_Images/winter.png", "/Project_Images/summer.png", "/Project_Images/monsoon.png"};

    private String[] animalAudioPaths = {"/Project_Images/winter_audio.mp3", "/Project_Images/summer_audio.mp3", "/Project_Images/monsoon_audio.mp3"};
    ...
    private double[] infoTranslateX = {240, 260, 300};
    private double[] infoTranslateY = {0, -10, 20};
    ...
    private Scene createAnimalScene(Stage stage, int animalIndex) throws IOException {
        ...
        hyperlink.setOnAction(e -> {
            ...
            switch (animalIndex) {
                case 0: // Lion
                    getHostServices().showDocument("https://en.wikipedia.org/wiki/Winter");
                    break;
                case 1: // Elephant
                    getHostServices().showDocument("https://en.wikipedia.org/wiki/Summer");
                    break;
                case 2: // Tiger
                    getHostServices().showDocument("https://en.wikipedia.org/wiki/Monsoon");
                    break;
                default:
                    break;
            }
